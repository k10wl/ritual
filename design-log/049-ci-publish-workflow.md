...
Status: PR (`fix/publish-format-and-toolchain` → `dev`) pending open. Verification steps 4–5 from the Implementation Plan remain open pending merge + a clean `publish-dev` run.
