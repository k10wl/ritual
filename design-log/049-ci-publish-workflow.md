...
Status: PR #15 open (2 commits: golangci-lint fix + frontend-build-before-publish fix). Verification steps 4–5 from the Implementation Plan remain open pending merge + a clean `publish-dev` run.
