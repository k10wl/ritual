...
| 013 | [Dialed GUI cutover](013-dialed-gui-cutover.md) | 2026-05-21 | Draft | Execute #007 Phase C: `ritual-app.ts` renders `<ritual-dial>` + telemetry/addresses under-slot directly; delete `frontend/src/stages/` + `error-banner`; lifts `dial-composition` story shape into production. |
