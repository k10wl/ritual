...
func TestNewBackupperService(t *testing.T) {
	...
	defer root.Close()
	service, err := NewBackupperService(buildArchive, targets, root)
	require.NoError(t, err)
...
func TestNewBackupperService_NilBuildArchive(t *testing.T) {
	...
	require.NoError(t, err)
	defer root.Close()
	_, err = NewBackupperService(nil, targets, root)
	require.Error(t, err)
...
func TestNewBackupperService_EmptyTargets(t *testing.T) {
	...
	require.NoError(t, err)
	defer root.Close()
	_, err = NewBackupperService(buildArchive, []ports.BackupTarget{}, root)
	require.Error(t, err)
...
func TestBackupperService_Run_HappyScenario(t *testing.T) {
	...
	backupper, err := NewBackupperService(buildArchive, targets, root)
	require.NoError(t, err)
