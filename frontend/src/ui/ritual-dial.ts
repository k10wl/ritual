    ...
    static styles = css`
        ...
        .dial {
            ...
            box-shadow:
                ...
                0 28px 60px -18px color-mix(in srgb, var(--c) 55%, transparent),
        ...
        @keyframes breathe {
            from { box-shadow:
                inset 0 1px 0 rgba(255, 255, 255, 0.10),
                inset 0 -1px 2px rgba(0, 0, 0, 0.45),
                0 24px 50px -20px color-mix(in srgb, var(--c) 40%, transparent),
                0 0 0 1px rgba(255, 255, 255, 0.06); }
            to   { box-shadow:
                inset 0 1px 0 rgba(255, 255, 255, 0.10),
                inset 0 -1px 2px rgba(0, 0, 0, 0.45),
                0 36px 80px -16px color-mix(in srgb, var(--c) 75%, transparent),
        ...
        .glyph {
            ...
            height: 56px;
            color: var(--c);
            filter: drop-shadow(0 4px 12px color-mix(in srgb, var(--c) 55%, transparent));
